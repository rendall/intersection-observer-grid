    ...
    return (
      <section className="controller">
        ...
        <p>
          ...
          to determine which of the 10,000 elements on the left are in view and
          should be rendered.
        </p>
        <p>
          As the user scrolls, the intersection observer callback receives only
          those elements with changed
          <code>isInteresecting</code> status
        </p>
        <p>
          Zooming in and out is performant and works properly, because layout is
          performed by the browser engine and not javascript
        </p>
      ...
      <div className="observer-option">
        ...
        <p>
          <a href="./">See it done with vanilla JS</a>
        </p>
        <p>
          <a href="https://github.com/rendall/intersection-observer-grid">
            Github repo
          </a>
        </p>
      </section>
