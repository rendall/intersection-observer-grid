...
(() => {
      ...
      448: (e, t, n) => {
        ...
        function tu(e) {
          switch (e.tag) {
            ...
            case 3:
              if ((za(), al(sl), al(il), Wa(), 0 != (64 & (t = e.flags))))
                throw Error(o(285));
        ...
        function ui(e, t, n) {
          ...
          Vt(e, t, n), e === _u && ((Iu |= t), 4 === Lu && fi(e, Nu));
          var r = jl();
          1 === t
            ? 0 != (8 & Cu) && 0 == (48 & Cu)
              ? di(e)
        ...
        function si(e, t) {
          ...
          if (((r = Ft(e, e === _u ? Nu : 0)), (t = Rt), 0 === r))
            ...
            15 === t
              ? ((n = di.bind(null, e)),
                null === Rl ? ((Rl = [n]), (Il = kl(Pl, Wl))) : Rl.push(n),
                (n = Ol))
              : (n =
                  14 === t
        ...
        function yi(e, t) {
          ...
          if ((Gl(), (Cu = n), (Su.current = r), null !== Pu))
            throw Error(o(261));
        ...
        function xi(e, t) {
          ...
          if ((si(e, Ul()), $u)) throw (($u = !1), (e = Wu), (Wu = null), e);
              ...
              o > u
                ? ((e.sortIndex = o),
                  ...
                  null === S(_) &&
                    e === S(P) &&
                    (M ? l() : (M = !0), r(I, o - u)))
                : ((e.sortIndex = i), E(_, e), O || L || ((O = !0), n(F))),
              e
            );
          }),
  ...
  (() => {
    ...
    class r extends e.PureComponent {
      ...
      handleChange(e) {
        const t = e.target.id.split("-")[0],
          n = Object.assign(Object.assign({}, this.state), {
            [t]: e.target.value,
          });
        this.setState(n);
      }
      render() {
        const { number: t, margin: n, threshold: r } = this.state;
        return e.createElement(
          "section",
          { className: "controller" },
          e.createElement("h2", null, "Intersection Observer"),
          e.createElement(
            "p",
            null,
            ...
            " to determine which of the 10,000 elements on the left are in view and should be rendered."
          ),
          e.createElement(
            "p",
            null,
            "As the user scrolls, the intersection observer callback receives only those elements with changed",
            e.createElement("code", null, "isInteresecting"),
            " status"
          ),
          e.createElement(
            "p",
            null,
            "Zooming in and out is performant and works properly, because layout is performed by the browser engine and not javascript"
          ),
          e.createElement("p", { id: "rendered-number" }),
          e.createElement(
            "p",
            null,
            e.createElement("a", { href: "./" }, "See it done with vanilla JS")
          ),
          e.createElement(
            "p",
            null,
            e.createElement(
              "a",
              { href: "https://github.com/rendall/intersection-observer-grid" },
              "Github repo"
            )
          )
        );
          ...
          t.isInView &&
            e.createElement(
              ...
              e.createElement("img", {
                ...
                src: `https://source.unsplash.com/random/160x160?${t.i}`,
              }),
              e.createElement("p", { className: "number-display" }, t.i)
            )
        );
        var r;
      },
      a = new Array(1e4).fill(0).map((e, t) => t);
    class o extends e.Component {
      constructor(t) {
        ...
        super(t),
          (this.callback = (e, t) => {
            const n = ((e, t) => {
              const n = e.isInView.map((e, n) =>
                ((e, t, n) => {
                  const r = n.find((t) => t.target.id === `${e}`);
                  return r ? r.isIntersecting : t;
                })(n, e, t)
              );
              return Object.assign(Object.assign({}, e), { isInView: n });
            })(this.state, e);
            this.setState(n);
          }),
          (this.getHeader = (t) =>
            e.createElement("h2", { key: `h${t}` }, "Header ", t)),
          (this.cells = () =>
            a.map((t) =>
              e.createElement(l, {
                isInView: this.state.isInView[t],
          ...
          (this.list = () =>
            this.cells().reduce(
              (e, t, n) => (n % 100 ? [...e, t] : [...e, this.getHeader(n), t]),
              []
            )),
          (this.state = { isInView: a.map(() => !1) }),
          (this.observer =
            ((n = this.callback),
    ...
    const u = document.querySelector("#react-app");
    t.render(
      e.createElement(() =>
        e.createElement(
          e.Fragment,
          ...
          e.createElement(r, { number: 1e4, margin: 0, threshold: 1 })
        )
      ),
      u
    );
